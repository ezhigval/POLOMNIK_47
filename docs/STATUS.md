...
Код линейки v3 начат: этапы **0–1** в `main`; этап **2** — меню по правам, фильтры заявок/CSV, шаблоны ролей (пресеты формы). Этап **3** начат: identity и слияние кабинета; правка профиля (`PATCH /me`). Пассажиры — ещё нет.  
