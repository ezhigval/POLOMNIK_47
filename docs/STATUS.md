...
Код линейки v3 начат: этапы **0–1** в `main`; этап **2** — меню по правам, фильтры заявок/CSV, шаблоны ролей (пресеты формы). Этап **3**: identity и слияние кабинета, правка профиля (`PATCH /me`) — **на проде** (деплой 2026-08-23, goose 15). Пассажиры — в коде (миграция 00016), ещё не деплой.  
