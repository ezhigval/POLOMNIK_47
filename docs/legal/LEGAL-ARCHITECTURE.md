...
- ЛК: `/account/consents` — история, реклама, отзыв распространения
- Админка: `/management/legal` — версии документов и факты согласий
- Cookie: Metrika/GA загружаются только при выборе «Принять все»
