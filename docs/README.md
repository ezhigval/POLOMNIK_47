...
| [MAIL_DNS.md](MAIL_DNS.md) | MX / SPF / DKIM для `info@` через Яндекс 360, затем SMTP |
| [MAIL_SELFHOST.md](MAIL_SELFHOST.md) | Свой MX на ВМ: что нужно (порт 25 YC, DNS, админка) |
