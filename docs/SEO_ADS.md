...
Съём частот и посадка фраз на URL в v4 этапе 10: **[SEO_WORDSTAT.md](SEO_WORDSTAT.md)** (Wordstat, без выдуманных цифр и без дорвеев).
...
- [x] `NEXT_PUBLIC_YM_ID=111985266`, `NEXT_PUBLIC_YM_WEBVISOR=1` (карта кликов по умолчанию вкл.; freeze v3.0.0)
- [ ] при необходимости `NEXT_PUBLIC_GA_ID` в prod
- [ ] В Метрике видны `tour_view` / `booking_submit` (кабинет Метрики — у владельца)
- [ ] Sitemap в Вебмастере и Search Console — нажать «Проверить» (только владелец)
