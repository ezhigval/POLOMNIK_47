...
**Канон для агентов: [AGENTS.md](../AGENTS.md). Релиз: [RELEASE.md](RELEASE.md).**

Ниже — исторический промпт Stage A–C. Если он противоречит `AGENTS.md` или факту продакшена (auth, JWT, единый домен palomnik), побеждает `AGENTS.md`.

Ты агент разработки проекта PALOMNIK 47.
