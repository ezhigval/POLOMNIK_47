	...
	return []homeBlockSpec{
		{
			...
			Content: json.RawMessage(`{
				...
				"subtitle":"Организуем поездки в монастыри и святые места: продуманная программа, комфортный транспорт и священник на маршруте. Вы выбираете тур — мы берём на себя всё остальное."
			}`),
		},
		...
		},
		{
			...
			Content: json.RawMessage(`{
				...
				"items":[
					...
					{"title":"Сопровождение священника","description":"На каждой поездке — священнослужитель, который помогает сосредоточиться на главном: молитве, покаянии и встрече со святынями.","icon":"cross"},
