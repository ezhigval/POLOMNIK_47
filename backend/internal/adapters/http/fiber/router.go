...
func NewRouter(cfg config.Config, log *slog.Logger, services Services, health HealthDeps) *fiber.App {
	...
	management.Post("/cms/pages", require(domain.PermManageContent), h.ManagementCreateCMSPage)
	...
	management.Delete("/cms/pages/:id", require(domain.PermManageContent), h.ManagementDeleteCMSPage)
